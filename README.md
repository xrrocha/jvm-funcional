...
[lenguaje de dominio específico orientado a JPA](java-scott/) (DSL) que simplifica el uso de repositorios en 
aplicaciones 
SpringBoot.
El ejemplo en Kotlin es una 
[implementación del patrón arquitectónico Memory Image](kotlin-memimg/).
